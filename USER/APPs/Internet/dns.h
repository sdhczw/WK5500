...
#define  DNS_RESPONSE_TIMEOUT   1       // 3 seconds
#define  DNS_RETRY              4       //4 times
#define  DNS_RET_FAIL           0
#define  DNS_RET_SUCCESS        1

#define  EXTERN_DNS_SERVERIP    Config_Msg.DNS_Server_IP
...
extern uint8 dns_ok;
//API½Ó¿Ú
extern uint8 Dns_Task(uint8* name,uint8* ip);
extern void Dns_Tick(void);
